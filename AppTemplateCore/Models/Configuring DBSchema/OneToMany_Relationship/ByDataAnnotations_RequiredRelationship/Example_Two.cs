...
namespace AppTemplateCore.Models.Configuring_DBSchema.OneToMany_Relationship8
{
    ...
    public class Evaluation
    {
        ...
        //We have applied the[ForeignKey] attribute on top of the Student 
        // property(which is a Navigation Property) giving it a name of the 
        // foreign key property StudentId.

        //navigation property in the dependent entity        
        public Guid StudentId { get; set; }// F.Key, For Required Relationship
